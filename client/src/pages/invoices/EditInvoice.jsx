...
import { FaSave, FaFileInvoice, FaPlus, FaTrash, FaArrowLeft } from 'react-icons/fa';
import { fetchInvoice, updateInvoice, getNextInvoiceNumber } from '../../services/invoice';
...
export default function EditInvoice() {
  ...
  async function loadInvoice() {
    try {
      ...
      setItems(data.items.length > 0 ? data.items : [{ itemName: '', description: '', quantity: 1, price: 0, discount: 0, tax: 0 }]);
    } catch (error) {
  ...
  function addItem() {
    setItems(prev => [...prev, { itemName: '', description: '', quantity: 1, price: 0, discount: 0, tax: 0 }]);
  }
